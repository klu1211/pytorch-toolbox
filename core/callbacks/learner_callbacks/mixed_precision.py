...
from pytorch_toolbox.core.utils.training import split_layers_into_batch_norm_and_non_batch_norm
...
def model_g2master_g(model_params: Sequence[Tensor], master_params: Sequence[Tensor],
