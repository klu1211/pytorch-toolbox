...
from pytorch_toolbox.pipeline import (
    Node,
    Reference,
    find_references,
    replace_arguments,
...
def test_flatten_resources_dict():
        ...
        "Resources": {
            "Group_A": {
                "SubGroup_A": {
                    ...
                    "Resource_A2": {
                        "properties": {
                            "arguments": {"arg1": "Group_A.SubGroup_A.Resource_A2"}
                        }
                    },
                }
            },
    ...
    assert flattened_resources == {
        "Resource_A1": {"properties": "Group_A.SubGroup_A.Resource_A1"},
        "Resource_A2": {
            "properties": {"arguments": {"arg1": "Group_A.SubGroup_A.Resource_A2"}}
        },
...
def test_replace_references():
    ...
    arguments_with_references_replaced = replace_references(
        graph, arguments_with_reference_to_node_a
    )
